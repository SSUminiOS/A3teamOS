...
printint(int fd, int xx, int base, int sgn)
{
 ...
 342:	f7 f1                	div    %ecx
 344:	0f b6 92 f8 06 00 00 	movzbl 0x6f8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 4e2:	e9 06 ff ff ff       	jmp    3ed <printf+0x49>
          s = "(null)";
 4e7:	bb ef 06 00 00       	mov    $0x6ef,%ebx
        while(*s != 0){
 ...
 591:	77 10                	ja     5a3 <free+0x31>
{
 ...
 5bc:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5be:	a3 6c 09 00 00       	mov    %eax,0x96c
}
 5c3:	5b                   	pop    %ebx
 5c4:	5e                   	pop    %esi
 5c5:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5fa:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5fd:	8b 15 6c 09 00 00    	mov    0x96c,%edx
 ...
 625:	eb 72                	jmp    699 <malloc+0xb5>
    base.s.ptr = freep = prevp = &base;
 627:	c7 05 6c 09 00 00 70 	movl   $0x970,0x96c
 62e:	09 00 00 
 631:	c7 05 70 09 00 00 70 	movl   $0x970,0x970
 638:	09 00 00 
    base.s.size = 0;
 63b:	c7 05 74 09 00 00 00 	movl   $0x0,0x974
 642:	00 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 645:	b8 70 09 00 00       	mov    $0x970,%eax
 ...
 658:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 65b:	89 15 6c 09 00 00    	mov    %edx,0x96c
      return (void*)(p + 1);
 ...
 67e:	e8 ef fe ff ff       	call   572 <free>
  return freep;
 683:	8b 15 6c 09 00 00    	mov    0x96c,%edx
      if((p = morecore(nunits)) == 0)
 ...
 69b:	39 05 6c 09 00 00    	cmp    %eax,0x96c
