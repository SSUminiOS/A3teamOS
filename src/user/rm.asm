...
main(int argc, char *argv[])
{
  ...
  2c:	ff 33                	push   (%ebx)
  2e:	e8 5b 02 00 00       	call   28e <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 322:	f7 f6                	div    %esi
 324:	0f b6 92 08 07 00 00 	movzbl 0x708(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 405:	ff 24 95 b0 06 00 00 	jmp    *0x6b0(,%edx,4)
        printint(fd, *ap, 10, 1);
 ...
 47e:	e9 48 ff ff ff       	jmp    3cb <printf+0x45>
          s = "(null)";
 483:	bb a9 06 00 00       	mov    $0x6a9,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 550:	a1 7c 09 00 00       	mov    0x97c,%eax
 ...
 55f:	77 10                	ja     571 <free+0x2d>
{
 ...
 58a:	89 08                	mov    %ecx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 58c:	a3 7c 09 00 00       	mov    %eax,0x97c
}
 591:	5b                   	pop    %ebx
 592:	5e                   	pop    %esi
 593:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5bf:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5c2:	8b 15 7c 09 00 00    	mov    0x97c,%edx
 ...
 5e6:	eb 72                	jmp    65a <malloc+0xad>
    base.s.ptr = freep = prevp = &base;
 5e8:	c7 05 7c 09 00 00 80 	movl   $0x980,0x97c
 5ef:	09 00 00 
 5f2:	c7 05 80 09 00 00 80 	movl   $0x980,0x980
 5f9:	09 00 00 
    base.s.size = 0;
 5fc:	c7 05 84 09 00 00 00 	movl   $0x0,0x984
 603:	00 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 606:	b8 80 09 00 00       	mov    $0x980,%eax
 ...
 619:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 61c:	89 15 7c 09 00 00    	mov    %edx,0x97c
      return (void*)(p + 1);
 ...
 63f:	e8 00 ff ff ff       	call   544 <free>
  return freep;
 644:	8b 15 7c 09 00 00    	mov    0x97c,%edx
      if((p = morecore(nunits)) == 0)
 ...
 65c:	39 05 7c 09 00 00    	cmp    %eax,0x97c
